    ...
    <div class="col-lg-9 ml-auto" id="left-side">
      ...
      <div class="row pt-5 mt-3 mb-5">
        <div class="col-sm-12 mb-1">
          <h3 class="display-4 mt-auto" style="font-size: 1.6rem;"><i class="fas fa-search text-light fa-1x mr-3 text-dark mr-2"></i><strong class="pt-5">Result found</strong></h3>
        <hr>
        </div>
        <!-- search result -->
        <div class="row pt-2 mt-3 mb-5">
        <div class="col-sm-12 mb-1">
          <div class="bg-white border">
          <table class="table table-hover w-100">
            <tr>
              <th class="p-4 mr-5" style="width:100%;">Database</th>
              <th class="p-4 mr-5" style="width:100%;">Visite<th>
            </tr>
          <?php
          if(isset($_POST['search'])){
          $search = $_POST['search'];
          $sql = "SELECT * FROM search where search_name='$search'";
          $result = mysqli_query($con,$sql); 
          while($row = mysqli_fetch_assoc($result)){?>
            <tr>
              <td class="p-4" style="width:100%;"><?php echo $row['search_name'];?></td>
              <td class="p-4" style="width:100%;"><a href="<?php echo $row['path'];?>"><i class="fas fa-eye text-success pt-0 icon mr-3"></i><a></td>
              <td>
              </td>
            </tr>
          <?php 
            ...
            echo "<h2 class='text-danger'>Please enter database name in the search bar</h2>";}
            ?>
          </table>          
        </div>
        <hr>
