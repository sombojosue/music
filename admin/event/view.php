      ...
      <div class="row pt-5 mt-3 mb-5">
        ...
        <div class="bg-white border">
          ...
          while($row = mysqli_fetch_assoc($result)){?>
            <tr>
              <td class="w-52"><img src="<?php echo "../../".$row['event_img'];?>" class="img-fuid rounded img-cus" alt="image"></td>
              <td class="w-25"><?php echo $row['event_name'];?><br><?php echo $row['event_date'];?></td>
              <td class="w-50"><?php echo $row['event_msg'];?></td>
            </tr>
          <?php }?>
          </table>          
        </div>
