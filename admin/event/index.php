    ...
    <!-- Book show -->
      <div class="row pt-5 mt-3 mb-5">
        <div class="col-sm-12 mb-1">
          <h3 class="display-4 mt-auto" style="width:15%;font-size: 1.6rem;float: left;"><i class="fas fa-calendar text-light fa-1x mr-3 text-dark mr-3"></i><strong class="pt-5">Event</strong></h3> <a href="" class="btn btn-success" data-toggle="modal" data-target="#eventadd"><i class="fas fa-plus-circle pr-2 icon"></i>Add Event</a>
        <hr>
        </div>
        ...
        <div class="bg-white border">
          ...
          while($row = mysqli_fetch_assoc($result)){?>
            <tr>
              <td><img src="<?php echo "../../".$row['event_img'];?>" alt="image" class="img-fuid rounded" width="120"></td>
              <td><?php echo $row['event_name'];?></td>
              <td><?php echo $row['event_date'];?></td>
              <td><?php echo $row['event_msg'];?></td>
              <td>
