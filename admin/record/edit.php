...
?>
<?php
          $sql = "SELECT * FROM record where id='$id_event'";
    ...
    <!-- Book show -->
      ...
      <div class="col-sm-6 mb-2 bg-white background pt-3 mr-3">
        ...
        <input type="file" name="image" class="form-control-file mb-0  p-2">
		   ...
		   <input type="submit" name="editrecord" value="Edit" class="btn btn-primary w-50 mt-5 small-btn mb-2">
		   </div>
      </div> 
      </form>   
      </div>
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
        ...
        if($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" ) {
         ...
         $uploadOk = 0;
           ...
           {
            $sql_event = "update record set record_img ='$send_img',record_name='$send_name',record_date='$send_date' where id='$id_event'";
