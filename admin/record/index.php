    ...
    <!-- Book show -->
      <div class="row pt-5 mt-3 mb-5">
        <div class="col-sm-12 mb-1">
          <h3 class="display-4 mt-auto" style="width:15%;font-size: 1.6rem;float: left;"><i class="fas fa-microphone-alt text-light fa-1x mr-3 text-dark mr-3"></i><strong class="pt-5">Record</strong></h3> <a href="" class="btn btn-success" data-toggle="modal" data-target="#eventadd"><i class="fas fa-plus-circle pr-2 icon"></i>Add Record</a>
        <hr>
        </div>
        ...
        <div class="bg-white border">
          ...
          while($row = mysqli_fetch_assoc($result)){?>
            <tr>
              <td><img src="<?php echo "../../".$row['record_img'];?>" alt="image" class="img-fuid rounded" width="120" height="100"></td>
      ...
      <div class="row">
        <div class="col-sm-6  bg-white pt-2">
         ...
         <div class="col-sm-5 mb-2 bg-white pt-3">
           ...
           <input type="submit" name="addrecord" value="Add Record" class="btn btn-primary w-75 mt-5 small-btn">
        </div>
        </div>
       </form>
        </div>
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
        ...
        $sql_event = "insert into record(record_name,record_img,record_date) value('$send_name','$send_img','$send_date')";
