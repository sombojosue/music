...
?>
<?php
          $sql = "SELECT * FROM about where id='$id_event'";
          $result = mysqli_query($con,$sql); 
          while($row = mysqli_fetch_assoc($result)){
            $show_b = $row['about_name'];
            $date_b = $row['about_title'];
            $name_b = $row['about_msg'];
            }
?> 
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="row">
    ...
    <!-- Book show -->
      ...
      <div class="col-sm-6 mb-2 bg-white background pt-3 mr-3">
		   ...
		   <input type="submit" name="aboutedit" value="Edit" class="btn btn-primary w-50 mt-5 small-btn mb-2">
		   </div>
      </div> 
      </form>   
      </div>
...
if(isset($_POST["aboutedit"])) {
        ...
        $sql_event = "update about set about_name ='$send_show',about_title='$send_date',about_msg='$send_name' where id='$id_event'";
