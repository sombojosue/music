         ...
         <div class="col-lg-10 col-md-10 rightbar bg-dark ml-auto fixed-top py-2">
           <div class="row">
             ...
             <div class="col-md-5 small-hide">
              <form method="post" action="../seacrh.php" class="form-inline mb-0">
    ...
    <!-- Book show -->
      <div class="row pt-5 mt-3 mb-5">
        <div class="col-sm-12 mb-1">
          <h3 class="display-4 mt-auto" style="width:20%;font-size: 1.6rem;float: left;"><i class="far fa-newspaper text-light fa-1x mr-3 text-dark mr-3"></i><strong class="pt-5">Newsletter</strong></h3><br>
        <hr>
        </div>
