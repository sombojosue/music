...
<div class="container-fluid">
  <div class="row">
    ...
    <!-- Book show -->
      <div class="row pt-5 mt-3 mb-5">
        <div class="col-sm-12 mb-1">
          <h3 class="display-4 mt-auto" style="width:15%;font-size: 1.6rem;float: left;"><i class="fas fa-shopping-cart text-light fa-1x mr-3 text-dark mr-3"></i><strong class="pt-5">Book</strong></h3>
        <hr>
        </div>
        <br>
        ...
        <div class="bg-white border">
          <table class="table table-hover">
            <tr>
              <th class="w-25">Show name</th>
              <th class="w-25">Show date</th>
          ...
          while($row = mysqli_fetch_assoc($result)){?>
            <tr>
              <td class="w-25"><?php echo $row['showname'];?></td>
              <td class="w-25"><?php echo $row['showdate'];?><br><?php echo $row['event_date'];?></td>
    ...
    <a href="index.php" class="btn btn-success mt-4 btn-lg mt-5"><i class="fas fa-arrow-left pt-0"></i></a>
  </div>
</div>
