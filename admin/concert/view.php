    ...
    <!-- Book show -->
      <div class="row pt-5 mt-3 mb-5">
        <div class="col-sm-12 mb-1">
          <h3 class="display-4 mt-auto" style="width:15%;font-size: 1.6rem;float: left;"><i class="fas fa-calendar text-light fa-1x mr-3 text-dark mr-3"></i><strong class="pt-5">Event</strong></h3> <a href="index.php" class="btn btn-success"><i class="fas fa-plus-circle pr-2 icon"></i>Add Event</a>
        <hr>
        </div>
        ...
        <div class="bg-white border">
          ...
          while($row = mysqli_fetch_assoc($result)){?>
            <tr>
              <td class="w-52"><img src="<?php echo "../../".$row['concert_img'];?>" class="img-fuid rounded img-cus" alt="image" width="400"></td>
              <td class="w-25"><?php echo $row['concert_name'];?><br><?php echo $row['concert_date'];?></td>
              <td class="w-50"><?php echo $row['concert_place'];?></td>
            </tr>
          <?php }?>
          </table>          
        </div>
<br>
    ...
    <a href="index.php" class="btn btn-success mt-4 btn-lg"><i class="fas fa-arrow-left pt-0"></i></a>
  </div>
</div>
