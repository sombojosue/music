    ...
    <!-- Book show -->
      <div class="row pt-5 mt-3 mb-5">
        <div class="col-sm-12 mb-1">
          <h3 class="display-4 mt-auto" style="width:15%;font-size: 1.6rem;float: left;"><i class="fas fa-id-card-alt text-light fa-1x mr-3 text-dark mr-3"></i><strong class="pt-5">News</strong></h3> <a href="index.php" class="btn btn-success"><i class="fas fa-plus-circle pr-2 icon"></i>Add News</a>
        <hr>
        </div>
        ...
        <div class="bg-white border">
          ...
          while($row = mysqli_fetch_assoc($result)){?>
            <tr>
              <td class="w-52"><img src="<?php echo "../../".$row['news_img'];?>" class="img-fuid rounded img-cus" alt="image"></td>
              <td class="w-25"><?php echo $row['news_name'];?></td>
              <td class="w-50"><?php echo $row['news_date'];?></td>
            </tr>
          <?php }?>
          </table>          
        </div>
